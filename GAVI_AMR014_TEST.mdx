...
<Columns cols={3}>
  <Card title="Geographic and infrastructure limitations in remote areas." <FontAwesomeIcon icon="fa-regular fa-bell" />>
    **Solution:** Deploy mobile units, use geospatial mapping tools, and apply differentiated delivery models.
  </Card>
  <Card title="Gender norms restricting caregiver access.">
